...
import { BlindSignature } from './rsablind.mjs';
...
// debugger;
// console.log(Bob.key, JSEncrypt)

const Alice = {
  message: 'Hello Chaum!I am test, thankssfasfle',
  N: null,
  E: null,
  r: null,
  signed: null,
...
Bob.blinded = blinded;
console.log('blinded:', blinded.toByteArray(), new BigInteger().equals());
